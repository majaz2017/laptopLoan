<?php
/* Smarty version 3.1.31, created on 2020-10-07 00:10:39
  from "/home1/alexorco/public_html/library/alexor/private/Templates/admin/issues/issues-list.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5f7d5bdf123db0_39777595',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7af39632648b00d3c20f3819ba8c549bc596ae88' => 
    array (
      0 => '/home1/alexorco/public_html/library/alexor/private/Templates/admin/issues/issues-list.tpl',
      1 => 1602051036,
      2 => 'file',
    ),
  ),
...
function content_5f7d5bdf123db0_39777595 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="btn btn-outline-info btn-sm <?php if ($_smarty_tpl->tpl_vars['activeLanguage']->value->isRTL()) {?>ml-1<?php } else { ?>mr-1<?php }?> return-book" data-container="body" data-toggle="tooltip" title="<?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('t', array());
$_block_repeat=true;
echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
"><i class="fa fa-retweet"></i></a>
                        <?php }?>
                        <span data-container="body" data-toggle="tooltip" title="<?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('t', array());
$_block_repeat=true;
echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
" class="<?php if ($_smarty_tpl->tpl_vars['activeLanguage']->value->isRTL()) {?>ml-1<?php } else { ?>mr-1<?php }?>">
                        <a href="#" class="btn btn-outline-info btn-sm" data-target="#userSendEmailModal" data-book="<?php echo $_smarty_tpl->tpl_vars['issue']->value->getBook()->getId();?>
...
" class="btn btn-outline-info btn-sm <?php if ($_smarty_tpl->tpl_vars['activeLanguage']->value->isRTL()) {?>ml-1<?php } else { ?>mr-1<?php }?> lost-book" data-lost="<?php if ($_smarty_tpl->tpl_vars['issue']->value->isLost()) {?>true<?php } else { ?>false<?php }?>" data-container="body" data-toggle="tooltip" title="<?php if ($_smarty_tpl->tpl_vars['issue']->value->isLost()) {
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
                                ...
                                <li class="text-center">
                                    <button class="btn btn-outline-secondary delete-issue" data-url="<?php echo $_smarty_tpl->tpl_vars['routes']->value->getRouteString("issueDelete",array("issueId"=>$_smarty_tpl->tpl_vars['issue']->value->getId()));?>
">
