...
class UserRoutes implements RoutesInterface
{
    ...
    const USER_Laptop_ROUTE         = "userLaptop";
    ...
    public static function getRoutes()
    {
        $routes = [];
        /*************************************  USER  **********************************************************/
        $routes[UserRoutes::USER_LIST_VIEW_ROUTE] = new AdminRoute(
            _("User List View"),
            "/users(?:/page/(\\d+))?[/]??",
        ...
        $routes[UserRoutes::USER_CREATE_ROUTE] = new AdminRoute(
            _("User Create"),
            "/user/create[/]??",
        ...
        $routes[UserRoutes::USER_EDIT_ROUTE] = new AdminRoute(
            _("User Edit"),
            "/user/(\\d+)/edit[/]??",
        ...
        $routes[UserRoutes::USER_DELETE_ROUTE] = new AdminRoute(
            _("User Delete"),
            "/user/(\\d+)/delete[/]??",
        ...
        $routes[UserRoutes::USER_EMAIL_CHECK_ROUTE] = new PublicRoute(
            _("User Email Check"),
            "/user/check-email[/]??",
        ...
        $routes[UserRoutes::USER_PHOTO_UPLOAD_ROUTE] = new AdminRoute(
            _("User Photo Upload"),
            "/user/photo-upload/??",
        ...
        $routes[UserRoutes::USER_SEARCH_ROUTE] = new AdminRoute(
            _("User Search"),
            "/user/search[/]??",
