<?php
    ...
    class RequestDatabaseHelper extends DatabaseHelper {
         ...
         * @return array|null
         */
        public function getRequests($userId = null, $offset = null, $perPage = null, $sortColumn = null, $sortOrder = null) {
            ...
            if ($requestsQueryResult !== false) {
                ...
                foreach ($requestsQueryResult as $requestRow) {
                    ...
                    $request->setCreationDate(Helper::reformatDateTimeString($request->getCreationDate(),
