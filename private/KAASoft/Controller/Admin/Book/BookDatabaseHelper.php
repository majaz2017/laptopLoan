...
class BookDatabaseHelper extends DatabaseHelper
{
    ...
    public function getBooks($offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $booksQueryResult = $this->kaaSoftDatabase->select(
    ...
    {
        $queryResult = $this->kaaSoftDatabase->get(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            [
                "[>]" . KAASoftDatabase::$IMAGES_TABLE_NAME           => ["coverId" => "id"],
                "[>]" . KAASoftDatabase::$ELECTRONIC_BOOKS_TABLE_NAME => ["eBookId" => "id"],
    ...
    public function getBookGenresIds($bookId)
    {
        ...
        $genresQueryResult = $this->kaaSoftDatabase->select(
            KAASoftDatabase::$BOOK_GENRES_TABLE_NAME,
    ...
    public function getBookGenres($bookId, $offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $genreQueryResult = $this->kaaSoftDatabase->distinct()->select(
            KAASoftDatabase::$BOOK_GENRES_TABLE_NAME,
            ["[><]" . KAASoftDatabase::$GENRES_TABLE_NAME => ["genreId" => "id"]],
            array_merge(
                Genre::getDatabaseFieldNames(),
                [
                    KAASoftDatabase::$GENRES_TABLE_NAME . ".id",
    ...
    public function getBindings($offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $usersQueryResult = $this->kaaSoftDatabase->select(
            KAASoftDatabase::$BINDINGS_TABLE_NAME,
            array_merge(
                Binding::getDatabaseFieldNames(),
    ...
    public function getBookAuthorsIds($bookId)
    {
        ...
        $booksQueryResult = $this->kaaSoftDatabase->select(
            KAASoftDatabase::$BOOK_AUTHORS_TABLE_NAME,
    ...
    public function getBookAuthors($bookId, $offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $authorsQueryResult = $this->kaaSoftDatabase->distinct()->select(
            KAASoftDatabase::$BOOK_AUTHORS_TABLE_NAME,
            ["[><]" . KAASoftDatabase::$AUTHORS_TABLE_NAME => ["authorId" => "id"]],
            array_merge(
                Author::getDatabaseFieldNames(),
                [
                    KAASoftDatabase::$AUTHORS_TABLE_NAME . ".id",
    ...
    public function saveBook(Book $book)
    {
        ...
        //  ControllerBase::getLogger()->info($data);
        if ($book->getId() == null) {
            $data["actualQuantity"] = $data["quantity"];

            return $this->kaaSoftDatabase->insert(
                KAASoftDatabase::$BOOKS_TABLE_NAME,
                $data
            );
        } else {
            ...
            return $this->kaaSoftDatabase->update(
                KAASoftDatabase::$BOOKS_TABLE_NAME,
                $data,
                ["id" => $book->getId()]
            );
    ...
    public function updateBooks($books)
    {
        ...
        foreach ($books as $book) {
            if ($book instanceof Book) {
                $data = $book->getDatabaseArray();
                $updateResult = $this->kaaSoftDatabase->update(
                    KAASoftDatabase::$BOOKS_TABLE_NAME,
                    $data,
                    [KAASoftDatabase::$BOOKS_TABLE_NAME . ".id" => $book->getId()]
                ) !== false;
    ...
    public function saveBookAuthors($bookId, $authorIds)
    {
        ...
        foreach ($authorIds as $authorId) {
            $insertResult = $this->kaaSoftDatabase->insert(
                KAASoftDatabase::$BOOK_AUTHORS_TABLE_NAME,
                [
                    "bookId"   => $bookId,
                    "authorId" => $authorId
    ...
    {
        return $this->kaaSoftDatabase->delete(
            KAASoftDatabase::$BOOK_AUTHORS_TABLE_NAME,
            ["bookId" => $bookId]
        );
    }
    ...
    {
        return $this->kaaSoftDatabase->has(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            ["id" => $bookId]
        );
    }
    ...
    public function getAuthorBooks($authorId, $offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $booksQueryResult = $this->kaaSoftDatabase->distinct()->select(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            [
    ...
    public function getAuthorBooksCount($authorId)
    {
        ...
        return $this->kaaSoftDatabase->distinct()->count(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            ["[><]" . KAASoftDatabase::$BOOK_AUTHORS_TABLE_NAME => ["id" => "bookId"]],
            [KAASoftDatabase::$BOOKS_TABLE_NAME . ".id"],
            $queryParams
    ...
    public function getPublisherBooksCount($publisherId)
    {
        ...
        return $this->kaaSoftDatabase->count(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            [KAASoftDatabase::$BOOKS_TABLE_NAME . ".id"],
            $queryParams
        );
    ...
    {
        return (int)$this->kaaSoftDatabase->get(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            "quantity",
            ["id" => $bookId]
        );
    ...
    public function getFullBooks($offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $queryResult = $this->kaaSoftDatabase->select(
            KAASoftDatabase::$BOOKS_TABLE_NAME,
            [
                "[>]" . KAASoftDatabase::$IMAGES_TABLE_NAME     => ["coverId" => "id"],
                "[>]" . KAASoftDatabase::$PUBLISHERS_TABLE_NAME => ["publisherId" => "id"],
            ...
            foreach ($booksQueryResult as $bookRow) {
                ...
                if (isset($bookRow["issueId"])) {
                    ...
                    if ($isExpired) {
                        ...
                        $issue->setPenalty(Issue::calculatePenalty(
                            $user,
                            $issue
                        ));
    ...
    public function saveBookStores($bookId, $storeIds)
    {
        ...
        foreach ($storeIds as $storeId) {
            $insertResult = $this->kaaSoftDatabase->insert(
                KAASoftDatabase::$BOOK_STORES_TABLE_NAME,
                [
                    "bookId"  => $bookId,
                    "storeId" => $storeId
                ]
    ...
    public function saveBookLocations($bookId, $locationIds)
    {
        ...
        foreach ($locationIds as $locationId) {
            $insertResult = $this->kaaSoftDatabase->insert(
                KAASoftDatabase::$BOOK_LOCATIONS_TABLE_NAME,
                [
                    "bookId"     => $bookId,
    ...
    public function getBookStores($bookId, $offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $storesQueryResult = $this->kaaSoftDatabase->distinct()->select(
            KAASoftDatabase::$BOOK_STORES_TABLE_NAME,
            ["[><]" . KAASoftDatabase::$STORES_TABLE_NAME => ["storeId" => "id"]],
            array_merge(
                Store::getDatabaseFieldNames(),
                [
    ...
    {
        return $this->kaaSoftDatabase->has(
            KAASoftDatabase::$BOOK_RATINGS_TABLE_NAME,
            ["AND" => [
                "bookId" => $bookId,
                "userId" => $userId
            ]]
    ...
    public function getUserBookRating($bookId, $userId)
    {
        ...
        $rating = $this->kaaSoftDatabase->get(
            KAASoftDatabase::$BOOK_RATINGS_TABLE_NAME,
            "rating",
            ["AND" => [
                "bookId" => $bookId,
    ...
    {
        $databaseArray = $this->kaaSoftDatabase->get(
            KAASoftDatabase::$BOOK_RATINGS_TABLE_NAME,
            array_merge(
                BookRating::getDatabaseFieldNames(),
    ...
    private function getBookLocations($bookId, $offset = null, $perPage = null, $sortColumn = null, $sortOrder = null)
    {
        ...
        $locationsQueryResult = $this->kaaSoftDatabase->distinct()->select(
            KAASoftDatabase::$BOOK_LOCATIONS_TABLE_NAME,
            [
            ...
            array_merge(
                Location::getDatabaseFieldNames(),
                [
