...
class Book extends DatabaseEntity implements JsonSerializable
{
    ...
    public static function getObjectInstance(array $databaseArray)
    {
        ...
        $book->setMetaDescription(ValidationHelper::getString($databaseArray["metaDescription"]));
        $book->setMetaDescription(ValidationHelper::getString($databaseArray["metaDescription"]));
        $book->setBookPurchaseDate(ValidationHelper::getString($databaseArray["purchaseDate"]));
        $book->setWarrantyPeriod(ValidationHelper::getString($databaseArray["warrantyPeriod"]));
    ...
    public static function getDatabaseFieldNames()
    {
        return array_merge(
            ...
            [
                ...
                KAASoftDatabase::$BOOKS_TABLE_NAME . ".purchaseDate",
                KAASoftDatabase::$BOOKS_TABLE_NAME . ".warrantyPeriod"
            ]
        );
    }
    ...
    /**
     * @param mixed $bookPurchaseDate
     */
    public function setBookPurchaseDate($bookPurchaseDate)
    {
        $this->purchaseDate = $bookPurchaseDate;
    }
    /**
     * @return mixed
     */
    public function getBookPurchaseDate()
    {
        return  $this->purchaseDate;
    }
    /**
     * @param mixed $warrantyPeriod
     */
