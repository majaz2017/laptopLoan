            ...
            <div class="card" id="book-block">
                ...
                <form action="{$route}" method="post" class="card-body book-form validate" data-edit="{if $action == "create"}false{else}true{/if}">
                    ...
                    <div class="row">
                           ...
                           <div class="col-lg-3">
                            <div class="form-group">
                                <label for="purchaseDate" class="control-label">{t}Purchase Date{/t}</label>
                                <input type="text" class="form-control date-picker" autocomplete="off" name="purchaseDate" value="{if $action == "edit"}{$book->getBookPurchaseDate()}{/if}">
                            </div>
                        </div>
                         <div class="col-lg-3">
                            <div class="form-group">
                                <label for="warrantyPeriod" class="control-label">{t}Warranty Period{/t}</label>
                                <input type="text" class="form-control" autocomplete="off" name="warrantyPeriod" value="{if $action == "edit"}{$book->getWarrantyPeriod()}{/if}">
                            </div>
                        </div>
