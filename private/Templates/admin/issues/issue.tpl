                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="bookId" class="control-label">{t}Book{/t}</label>
                                    ...
                                    {if $action == "edit" and $issue->getBook()}
                                        <option value="{$issue->getBook()->getId()}" selected>{$issue->getBook()->getTitle()}</option>
                                    {/if}
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="userId" id="userId" class="form-control">
                                    {if $action == "edit" and $issue->getUser()}
                                        <option value="{$issue->getUser()->getId()}" selected>{$issue->getUser()->getFirstName()} {$issue->getUser()->getLastName()}</option>
                                    {/if}
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date-picker" autocomplete="off" name="issueDate" value="{if $action == "edit"}{$issue->getIssueDate()}{/if}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
