<nav class="sidebar-nav">
    <ul id="sidebar-menu">
        {if isset($user) and $user->getRole() != null and $user->getRole()->getPriority() <= 100}
            <li class="{if $activeRoute->getName() == 'userBooksView'}active{/if}">
                <a href="{$routes->getRouteString("userBooksView")}" aria-expanded="false"><img src="{$resourcePath}assets/images/icons/books.png" alt=""><span class="hide-menu">{t}Books{/t}
                </a>
            </li>
            <li class="{if $activeRoute->getName() == 'userRequestListView'}active{/if}">
                <a href="{$routes->getRouteString("userRequestListView")}" aria-expanded="false"><img src="{$resourcePath}assets/images/icons/req-book.png" alt=""><span class="hide-menu">{t}Requested Books{/t}</span></a>
            </li>
            <li class="{if $activeRoute->getName() == 'userIssuedBooksView'}active{/if}">
                <a href="{$routes->getRouteString("userIssuedBooksView")}" aria-expanded="false"><img src="{$resourcePath}assets/images/icons/issue-book.png" alt=""><span class="hide-menu">{t}Issued Books History{/t}
                </a>
            </li>
        {/if}
        {if isset($user) and $user->getRole() != null and $user->getRole()->getPriority() >= 100}
